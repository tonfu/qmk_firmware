...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_L1] = LAYOUT_65_ansi_blocker(
        ...
        _______,        KC_MRWD,    KC_MFFD,    _______,    _______,    _______,    _______,    KC_HOME,    KC_PGUP,    _______,    _______,    _______,    _______,    KC_DEL,     _______,
    ...
    [_L2] = LAYOUT_65_ansi_blocker(
        _______,        _______,    NK_TOGG,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_SLCK,
