...
#define KC_LOWERSPC LT(_L2,KC_SPC) // _LOWER layer mod when held, space when tapped
#define KC_RAISESPC LT(_L3,KC_SPC) // _RAISE layer mod when held, space when tapped
